...
- [ ] Implement working List View toggle (3D/List switch actually hides/shows content)
...
- [ ] Add touch controls for 3D view (pinch-to-zoom, touch-drag-to-rotate)
...
- [ ] Add sidebar collapse button visible on all screen sizes
...
- [ ] Add comprehensive meta tags and Open Graph tags to both HTML files
...
- [ ] Add "reserved" status support to data layer and both views
...
- [ ] Add enhanced search that filters tables by attributes (seats, smoking, window)
...
- [ ] Add venue details panel with address, hours, phone, and features
...
- [ ] Add smooth loading animation on initial page load
...
- [ ] Add hover tooltips on 3D tables showing quick info
...
- [ ] Improve admin panel with animated status transitions
...
- [ ] Add server assignment dropdown in admin panel
...
- [ ] Add table notes feature in admin panel
